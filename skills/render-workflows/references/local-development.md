...
- **Render CLI 2.4.2+**: `render --version`
...
```bash
render ea tasks dev --port 8121 -- python workflows/main.py
```
...
The SDK client (`Render()`) automatically detects these and routes requests to the local server.
