      ...
      <div className="max-w-4xl mx-auto prose prose-invert max-w-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border border-white p-6 not-prose">
              ...
              <p className="text-gray-400">
                Full-stack React framework with nested routes and server-side rendering.
              </p>
            </div>
            <div className="border border-white p-6 not-prose">
        ...
        <section className="py-16 text-center">
          ...
          <p className="text-gray-400 mb-8">
            Edit <code className="bg-white/10 px-2 py-1">app/routes/home.tsx</code> to get started.
          </p>
        </section>
      </div>
    </main>
